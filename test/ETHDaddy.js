...
describe("ETHDaddy", () => {
      let ethDaddy
      let deployer, owner1, hacker, buyer, user1, newOwner, accounts, address1, address2

      const NAME = "ETH Daddy";
      const SYMBOL = "ETHD";

      beforeEach(async () => {
        [deployer, owner1, hacker, buyer, user1, newOwner, accounts, address1, address2] = await ethers.getSigners();
